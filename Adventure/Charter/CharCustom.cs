...
namespace Adventure
{
    public class CharCustom
    {
        ...
        string playerName;
        //info로 넘길 이름값
        public void MakeName(PlayerInfo player, Shop shop, Inventory inventory, PlayerInfo monster)
        {
            Console.WriteLine("게임에서 사용할 이름을 작성해주세요.");
            playerName = Console.ReadLine();
            Console.Clear();
            ChoiceClass(player,shop,inventory, monster);
        }
        ...
        public void ChoiceClass(PlayerInfo player, Shop shop, Inventory inventory, PlayerInfo monster)
        {
            ...
            while (true)
            {
                ...
                switch (input)
                {
                    case 1:
                        ...
                        goMain.mainScence(player,shop,inventory,monster);
